...
board3 = Board.create(coordinates: "[50, 100], [100, 200], [60, 70]", name: "board three", team: spencer)
board4 = Board.create(coordinates: "[50, 80, 29, 100, 150, 180]", name: "board four", team: surbiton)
